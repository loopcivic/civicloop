...
// // //     CheckCircle2, Clock, ArrowLeft, Building2, BadgeCheck
// // // } from "lucide-react";
...
// // //                 // 2. If Citizen, Fetch Their Complaints history
// // //                 if (userData.role === "CITIZEN") {
// // //                     // Assuming /complaints returns all, we filter client-side for now
// // //                     // (Ideally backend should have /complaints/me)
// // //                     const allComplaints = await apiGet<any[]>("/complaints");
// // //                     const mine = allComplaints.filter((c: any) => c.createdById === userData.id);
...
// // //                                         {/* ✅ FIX: Read directly from user.department */}
...
// // //                                         {/* ✅ FIX: Read directly from user.ward */}
// // //                                         <div className="text-sm font-medium text-zinc-200">
// // //                                             {user.ward?.name || "General"}
// // //                                         </div>
// // //                                     </div>
// // //                                 </div>
// // //                             </div>
...
// // //                     {/* <div className="bg-zinc-950/50 rounded-2xl p-6 border border-white/5 min-w-[200px] text-center">
// // //                         {isOfficer ? (
// // //                             <>
// // //                                 <div className="text-3xl font-bold text-white mb-1">--</div>
// // //                                 <div className="text-xs text-zinc-500 uppercase tracking-widest font-bold">Tasks Resolved</div>
// // //                                 <div className="mt-4 pt-4 border-t border-white/5">
// // //                                     <div className="text-amber-400 font-bold flex items-center justify-center gap-2"><BadgeCheck size={16} /> Active Duty</div>
// // //                                 </div>
// // //                             </>
// // //                         ) : (
// // //                             <>
// // //                                 <div className="text-3xl font-bold text-white mb-1">{myComplaints.length}</div>
// // //                                 <div className="text-xs text-zinc-500 uppercase tracking-widest font-bold">Total Reports</div>
// // //                                 <div className="mt-4 pt-4 border-t border-white/5 space-y-2">
// // //                                     <div className="flex justify-between text-xs text-zinc-400">
// // //                                         <span>Resolved</span>
// // //                                         <span className="text-green-400">{myComplaints.filter(c => c.currentStatus === 'RESOLVED').length}</span>
// // //                                     </div>
// // //                                     <div className="flex justify-between text-xs text-zinc-400">
// // //                                         <span>Pending</span>
// // //                                         <span className="text-blue-400">{myComplaints.filter(c => c.currentStatus !== 'RESOLVED').length}</span>
// // //                                     </div>
// // //                                 </div>
// // //                             </>
// // //                         )}
...
// // //                     {/* --- 2. TASK LIST SECTION (Unified for Officer & Citizen) --- */}
// // //                     <div className="space-y-6">
// // //                         <h2 className="text-xl font-bold text-white flex items-center gap-2">
// // //                             {isOfficer ? <BadgeCheck className="text-amber-500" /> : <Clock className="text-blue-500" />}
// // //                             {isOfficer ? "My Assignments" : "Recent Activity"}
// // //                         </h2>

// // //                         {/* Determine which list to show */}
// // //                         {(() => {
// // //                             const listToShow = isOfficer ? user.assignedComplaints : myComplaints;
...
// // //                                         <p>{isOfficer ? "No tasks assigned yet." : "You haven't submitted any reports yet."}</p>
// // //                                     </div>
// // //                                 );
// // //                             }
...
// // //                           ${complaint.currentStatus === 'RESOLVED' ? 'bg-green-500/10 text-green-500' :
// // //                                                         complaint.currentStatus === 'ASSIGNED' ? 'bg-amber-500/10 text-amber-500' :
// // //                                                             'bg-blue-500/10 text-blue-500'}
// // //                         `}>
// // //                                                     {complaint.currentStatus === 'RESOLVED' ? <CheckCircle2 size={20} /> :
// // //                                                         complaint.currentStatus === 'ASSIGNED' ? <BadgeCheck size={20} /> :
// // //                                                             <Clock size={20} />}
// // //                                                 </div>
...
// // //                                                             <>
// // //                                                                 <span>•</span>
// // //                                                                 <span className="text-zinc-400">{complaint.ward.name}</span>
// // //                                                             </>
// // //                                                         )}
// // //                                                     </div>
// // //                                                 </div>
...
// // //                           ${complaint.currentStatus === 'RESOLVED' ? 'bg-green-500/10 text-green-400' :
// // //                                                         complaint.currentStatus === 'ASSIGNED' || complaint.currentStatus === 'WORK_IN_PROGRESS'
...
// // //                                             </div>
// // //                                             <div>
// // //                                                 <h3 className="text-white font-medium group-hover:text-blue-400 transition">{complaint.title}</h3>
// // //                                                 <p className="text-xs text-zinc-500">{new Date(complaint.createdAt).toLocaleDateString()} • {complaint.category}</p>
// // //                                             </div>
// // //                                         </div>
// // //                                         <div className="text-right hidden md:block">
// // //                                             <span className={`
// // //                           px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider
// // //                           ${complaint.currentStatus === 'RESOLVED' ? 'bg-green-500/10 text-green-400' : 'bg-blue-500/10 text-blue-400'}
// // //                         `}>
// // //                                                 {complaint.currentStatus.replace(/_/g, " ")}
// // //                                             </span>
// // //                                         </div>
...
// //                     {/* ✅ STATS BOX (Strictly Counts Only) */}
...
// //                                             <BadgeCheck size={16} /> All Tasks Clear
// //                                         </div>
// //                                     )}
// //                                 </div>
// //                             </>
...
// //                 {/* ✅ TASK LIST SECTION (Moved Outside & Below Header) */}
// //                 <div className="space-y-6">
// //                     <h2 className="text-xl font-bold text-white flex items-center gap-2">
// //                         {isOfficer ? <BadgeCheck className="text-amber-500" /> : <Clock className="text-blue-500" />}
// //                         {isOfficer ? "My Assignments" : "Recent Activity"}
...
// } from "lucide-react";
// import { apiGet, apiPost } from "@/lib/api"; // 👈 Added apiPost
...
//         try {
//             // 1. Tell Backend to Destroy Cookie
...
export default function ProfilePage() {
    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-zinc-950 flex items-center justify-center text-zinc-500 text-sm sm:text-base">
                Loading Profile...
            </div>
        );
    }
            ...
            <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8">
                ...
                <div className="bg-zinc-900/50 border border-white/5 rounded-2xl sm:rounded-3xl p-6 sm:p-8 flex flex-col md:flex-row gap-6 sm:gap-8 items-center md:items-start relative overflow-hidden">
                    ...
                    <div className="bg-zinc-950/50 rounded-2xl p-4 sm:p-6 border border-white/5 w-full md:w-auto md:min-w-[200px] text-center shrink-0">
                        {isOfficer ? (
                                ...
                                <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-white/5">
                                    {pendingCount > 0 ? (
                                        ...
                                        <div className="text-green-400 font-bold flex items-center justify-center gap-2 text-xs sm:text-sm">
                                            <BadgeCheck size={14} className="sm:w-4 sm:h-4" /> All Tasks Clear
                                        </div>
                                    )}
                                </div>
                            </>
                            ...
                            <>
                                <div className="text-2xl sm:text-3xl font-bold text-white mb-1">{myComplaints.length}</div>
                                <div className="text-[10px] sm:text-xs text-zinc-500 uppercase tracking-widest font-bold">Total Reports</div>
                                <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-white/5 space-y-2">
                                    <div className="flex justify-between text-[10px] sm:text-xs text-zinc-400">
                                        <span>Resolved</span>
                                        <span className="text-green-400 font-bold">{myComplaints.filter(c => c.currentStatus === 'RESOLVED').length}</span>
                                    </div>
                                    <div className="flex justify-between text-[10px] sm:text-xs text-zinc-400">
                                        <span>Pending</span>
                                        <span className="text-blue-400 font-bold">{myComplaints.filter(c => c.currentStatus !== 'RESOLVED').length}</span>
                                    </div>
                                </div>
                            </>
                        )}
                ...
                <div className="space-y-4 sm:space-y-6">
                    <h2 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                        {isOfficer ? <BadgeCheck className="text-amber-500 w-5 h-5 sm:w-6 sm:h-6" /> : <Clock className="text-blue-500 w-5 h-5 sm:w-6 sm:h-6" />}
                        {isOfficer ? "My Assignments" : "Recent Activity"}
                    </h2>
                            ...
                            <div className="grid gap-3 sm:gap-4">
                                {listToShow.map((complaint: any) => (
                                    ...
                                    >
                                        <div className="flex items-center gap-3 sm:gap-4">
                                            ...
                                            <div className={`
                                                ...
                                                ${complaint.currentStatus === 'RESOLVED' ? 'bg-green-500/10 text-green-500' :
                                                    ...
                                                    'bg-blue-500/10 text-blue-500'}
                                            `}>
                                                {complaint.currentStatus === 'RESOLVED' ? <CheckCircle2 size={18} className="sm:w-5 sm:h-5" /> :
                                                    complaint.currentStatus === 'ASSIGNED' ? <BadgeCheck size={18} className="sm:w-5 sm:h-5" /> :
                                        ...
                                        {/* Status Badge - Now visible on mobile, nicely indented under the text */}
                                        <div className="pl-[3.25rem] sm:pl-0 sm:text-right">
                                            <span className={`
                                                px-2.5 sm:px-3 py-1 rounded-full text-[9px] sm:text-[10px] font-bold uppercase tracking-wider
                                                ${complaint.currentStatus === 'RESOLVED' ? 'bg-green-500/10 text-green-400' :
                                                    complaint.currentStatus === 'ASSIGNED' || complaint.currentStatus === 'WORK_IN_PROGRESS'
                                                        ? 'bg-amber-500/10 text-amber-400'
                                                        : 'bg-blue-500/10 text-blue-400'}
